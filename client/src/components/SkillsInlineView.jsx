...
const SkillsInlineView = () => {
  ...
  const fetchCareers = useCallback(async () => {
    try {
      const response = await axios.get(`${apiUrl}/api/careerIds`);
  ...
  const handleSelectCareer = async (careerId) => {
    ...
    setError(null);
    try {
      const response = await axios.get(`${apiUrl}/api/skills/${careerId}`);
  ...
  const handleAddNewCareer = async () => {
    ...
    setError(null);
    try {
      await axios.post(`${apiUrl}/api/skills`, { career: career, count });
      setNewCareer('');
      await fetchCareers();
  ...
  const handleDeleteCareer = async (careerId) => {
    ...
    setError(null);
    try {
      await axios.delete(`${apiUrl}/api/skills/delete/${careerId}`);
...
export default SkillsInlineView;
