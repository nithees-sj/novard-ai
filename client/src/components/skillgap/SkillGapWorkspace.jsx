            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <span className={`text-sm font-semibold truncate ${active ? 'text-indigo-800' : 'text-gray-900'}`}>{s.targetRole}</span>
                  {loadingId === s._id
                    ? <span className="w-3.5 h-3.5 rounded-full border-2 border-gray-200 border-t-indigo-600 animate-spin" aria-hidden="true" />
